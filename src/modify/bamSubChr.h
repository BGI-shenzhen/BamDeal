...
void print_SubChr_Usage()
{
	cout<<""
		"\n"
		"\tUsage: bamSubChr -i <in.bam>  -d <list>  -o <out.bam>\n"
		"\tUsage: bamSubChr -i <in.bam>  -k <list>  -o <out.bam>\n"
		"\n"
		"\t\t-i      <str>     input SAM/BAMi file\n"
...
void More_HelpSubChr()
{
	cout<<""
		"\n"
		"\t\t1. bamSubChr -i <in.bam> -d <delete.list> -o AAA -r\n"
		...
		"\n"
		"\t\t2. bamSubChr -i <in.bam> -k <keep.list> -o AAA -r\n"
