...
void More_Help_FF()
{
	cout<<""
		...
		"\t\t   This will remove the aligned reads whose quality lower than 15 or length shorter than 30Mb and output the reads left to the file named AAA in current directory. \n"
		"\n"
		"\t\t2. BamFilter -i <in.bam> -o AAA -q Q -l L -s S -e E -c ChrX\n"
		"\t\t   This will remove the aligned reads whose quality lower than Q or length shorter than LMb or the 1-based leftmost mapping position of first matching base does not locate within [S,E], and output the reads left of ChrX to the file named AAA in current directory.\n"
		"\n";
}
